...
/* Special	 */
				...
				INSTANCE DannyHelp						(C_SFX_DEF) {file= "DIA_Danny_Help.wav";					vol = 80;		};
				INSTANCE Harp02						(C_SFX_DEF) {file= "HARP_02.wav";					vol = 80;		};
...
/* Troll */	                                                                                                            		
				...
				INSTANCE TRO_Hurt						(C_SFX_DEF) {file= "TRO_Hurt02.wav";				vol = 125;			};
...
// Replaced by KaiRo
				...
				INSTANCE Drown							(C_SFX_DEF) {file= "Swim_Drown.wav";				vol = 125;			};
...
/* ready */	                                                                                                                    
				INSTANCE Drawsound_ME					(C_SFX_DEF) {file= "Sword_Draw_02wav";				vol = 25;			}; 
				INSTANCE Drawsound_ME_A1				(C_SFX_DEF) {file= "Sword_Draw_02.wav";				vol = 25;			}; 
				INSTANCE Drawsound_WO					(C_SFX_DEF) {file= "Sword_Draw_02.wav";				vol = 25;			}; 
...
/* breath */	                                                                                                         
				INSTANCE D_Breath						(C_SFX_DEF) {file= "Breath01.wav";					vol = 65;    	  	};
				INSTANCE D_Breath_A1					(C_SFX_DEF) {file= "Breath02.wav";					vol = 65;    	  	};
				INSTANCE D_Breath_A2					(C_SFX_DEF) {file= "Breath03.wav";					vol = 65;    	  	};
				INSTANCE D_Breath_A3					(C_SFX_DEF) {file= "Breath02.wav";					vol =65;    	  	};
				INSTANCE D_Breath_A4					(C_SFX_DEF) {file= "Breath02.wav";					vol = 65;    	  	};
				INSTANCE D_Breath_A5					(C_SFX_DEF) {file= "Breath02.wav";					vol = 65;    	  	};
