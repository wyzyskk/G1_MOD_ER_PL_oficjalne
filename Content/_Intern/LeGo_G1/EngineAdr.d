...
//========================================
// Not all is ported cause of my lazy ass :)  - Chicken from theModders
const int zCView_Top 								= 7326736; //
...
const int oCNpc__OpenInventory                      = 7057568; //0x762250 Hook: Quickslots
...
const int _oCNpc__CloseInventory                    = 7058160; // .text:006BB2F0
...
const int _oCNpc__OpenInventory                     = 7057568; // .text:006BB0A0
const int _oCNpc__OpenInventory2					= 7057813; // 6BB195
const int _oCNpc__OpenSteal                         = 7058256; // .text:006BB350
const int _oCNpc__OpenTradeContainer                = 6503392; // .text:00633BE0

const int oCAniCtrl_Human_IsInWater 				= 6484544; // .text:0062F240 // public: int __thiscall oCAniCtrl_Human::IsInWater(void)
const int oCAniCtrl__Human_GetLayerAni				= 6451776; // .text:00627240  // public: class zCModelAniActive * __thiscall oCAniCtrl_Human::GetLayerAni(int)

const int zCModelAni__GetAniID						= 6427072; // .text:006211C0 // public: int __thiscall zCModelAni::GetAniID(void)const
const int zCModelAni__GetAniName					= 5759840; // .text:0057E360 // public: class zSTRING const & __thiscall zCModelAni::GetAniName(void)const

const int zCModel__GetAniIDFromAniName				= 4713552; // .text:0047EC50 // public: int __thiscall zCModel::GetAniIDFromAniName(class zSTRING const &)const
