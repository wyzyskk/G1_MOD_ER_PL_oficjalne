...
// Sliders
//========================================
const int SLIDER_ACTIVE = 1;
const int SLIDER_ENTERED = 2;

const string SLIDER_BACK = "Menu_Slider_Back.tga";
const string SLIDER_POS = "Menu_Slider_Pos.tga";
...
// Cursor
//========================================
const string Cursor_Texture   = "LO.TGA"; // Genutzte Textur, LeGo stellt eine "CURSOR.TGA" bereit
...
// Names
//========================================
const int AIV_Name = 49; // Genutzte AI-Var
