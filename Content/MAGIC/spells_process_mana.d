...
func INT Spell_ProcessMana(VAR INT manaInvested)
{
	...
	if (Npc_GetActiveSpell(self) == SPL_TELEPORT_ER		)	{	return	Spell_Logic_Teleport_er			(manaInvested);	};
	if (Npc_GetActiveSpell(self) == SPL_TELEPORT_OH		)	{	return	Spell_Logic_Teleport_OH			(manaInvested);	};
	if (Npc_GetActiveSpell(self) == SPL_TELEPORT_BC		)	{	return	Spell_Logic_Teleport_BC			(manaInvested);	};
	if (Npc_GetActiveSpell(self) == SPL_SUMMONORCSKE	)	{	return	Spell_Logic_SummonOrcSke			(manaInvested);	};
