...
INSTANCE magic_dmg_changer (C_Item)
{
	name 				=	"TEST";
	...
	scemeName				=	"MAP";	
	on_state[0]				=	UseDMGCHANGER;
	
	description			= 	name;
	TEXT[2]				= "TEST";
	TEXT[4]				= NAME_Value;					COUNT[4]	= value;
};
func void UseDMGCHANGER()
{

	PrintScreen	("SPL_DAMAGE_FIREBOLT = 100", -1,-1,"FONT_OLD_20_WHITE.TGA",2);
	SPL_DAMAGE_FIREBOLT = SPL_DAMAGE_FIREBOLT + 1000; 
};
// ************************************************************************************************
...
const int   SPL_PYRO_DAMAGE_PER_SEC_LOW	=	7;	// Pyrokinesis Ma³a //1.24
...
INSTANCE Spell_OrcSkeleton (C_Spell_Proto)
{
	time_per_mana			= 500;
	spelltype 				= SPELL_BAD;
	targetCollectAlgo		= TARGET_COLLECT_NONE;
