...
/*******************************************************************************************/
// TeleportEr (Scrolls und Runen)

INSTANCE ItArRuneTeleportHome (C_Item)
{
	name 				=	NAME_Rune;
	...
	spell				= 	SPL_TELEPORT_ER;

	description			= 	"Teleportacja do domu Maga";
	TEXT	[0]			=	NAME_Mag_Circle;			COUNT	[0]		=	mag_circle;
...
//******************NOWE TELPORTY***************************************
INSTANCE ItArRuneTeleport_ER (C_Item)
{
	name 				=	NAME_Rune;
...
INSTANCE ItArRuneTeleport_OH (C_Item)
{
	name 				=	NAME_Rune;
...
INSTANCE ItArRuneTeleport_BC (C_Item)
{
	name 				=	NAME_Rune;
...
//przyzwanie szkieleta orka
INSTANCE ItArRuneSummonOrcSke (C_Item)
{
	name 				=	NAME_Rune;
	...
	material			=	MAT_STONE;
	value				= 	2500;
	spell				= 	SPL_SUMMONORCSKE;
	cond_atr[2]   		=	ATR_MANA_MAX;
	cond_value[2]  		=	SPL_SENDCAST_SUMMONDEMON;
	mag_circle 			= 	5;   //Potê¿na runa!

	description			= 	"Przyzwanie orkowych szkieletów";
	TEXT	[0]			=	NAME_Mag_Circle;			COUNT	[0]		=	mag_circle;
	TEXT	[1]			=	NAME_Manakosten;			COUNT	[1]		=	SPL_SENDCAST_SUMMONDEMON;
};
/*******************************************************************************************/