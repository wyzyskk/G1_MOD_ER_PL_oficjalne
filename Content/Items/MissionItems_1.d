...
{	
	...
	visual 				= "ItMw_1H_Sword_Old_01.3DS";
	description			= name;
	TEXT[1]				= "Wyryto na nim znak 'J'";
	TEXT[2]				= "Z pewnoœci¹ ma jakiegoœ w³aœciciela";
	TEXT[3]				= "Mo¿e uda mi siê go znaleŸæ?";
	TEXT[2]				= NAME_Damage;
	COUNT[2]			= damageTotal;
	TEXT[3] 			= NAME_Str_needed;
	COUNT[3]			= cond_value[2];
...
{	
	name 					=	"Bagienne ziele od Baal Tarana";
	...
	visual 					=	"ItMi_Joint_01.3ds";//fixed
	material 				=	MAT_WOOD;

	scemeName				=	"JOINT";
	description			= name;
	TEXT[1]				= "Przeznaczone dla";
	TEXT[2]				= "nowych klientów.";
	TEXT[5]				= NAME_Value;
	COUNT[5]			= value;
};
	...
	instance EBR_Ring1(C_Item)
{
	...
	description		= " Pierœcieñ magantów. ";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
		...
		instance EBR_Ring2(C_Item)
{
	...
	description		= " Pierœcieñ prawdopodobnie nale¿y do Magnatów. Wygrawerowano na nim napis: W piêciu jest si³a...";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	TEXT[2]			= NAME_Prot_Fire;
...
{	
	...
	scemeName				=	"MAP";	
	on_state[0]				=	UseWorldmapHQ;

	description				= name;
	TEXT[0]					= "Mapa posiada";
	TEXT[1]					= "nazwy lokacj ";
	TEXT[2]					= "w Górniczej Dolinie.";
	TEXT[5]					= NAME_Value;
	COUNT[5]				= value;
};

	FUNC VOID UseWorldmapHQ()
	{
		var int nDocID;
		...
		nDocID = 	Doc_CreateMap	()			  ;							// DocManager 
					Doc_SetLevel	( nDocID,	"WORLD.ZEN" );
					Doc_SetPages	( nDocID, 1 );                         
					Doc_SetPage 	( nDocID, 0, "Map_World_HQ.tga", 	1	);  //  1 -> DO NOT SCALE 
...
{	
	...
	material 				=	MAT_LEATHER;
	description				= name;
	TEXT[0]					= "Ruda nale¿y do Bandyty Emanuela.";
	TEXT[5]					= NAME_Value;
	COUNT[5]				= value;
};	

/* ==================================
Zaginiony pos¹¿kek klina
========================================= */
...
INSTANCE it_glejtmagow (C_ITEM)
{	
	name 					=	"Glejt Magów Ognia";
	...
	on_state[0]				=	Use_glejtmagow;
};

	FUNC VOID Use_glejtmagow()
	{   
		var int nDocID;
		...
		nDocID = 	Doc_Create		()			  ;							
					...
					Doc_PrintLine	( nDocID,  0, "UZUPE£NIÆ TREŒÆ"					);
					Doc_SetMargins	( nDocID, -1, 200, 50, 50, 50, 1   		);  
				
					Doc_Show		( nDocID );	
	};
	
	INSTANCE it_firering(C_Item)
{
	name 					=	NAME_Ring;
	...
	visual_skin 				=	0;
	material 				=	MAT_METAL;
	on_equip				=	Equip_firering;
	on_unequip				=	UnEquip_firering;

	description		= "Pierœcieñ Magów Ognia";
	//TRZEBA UZUPE£NIÆ NA OCHRONA PRZED OGNIEM
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	TEXT[2]			= NAME_Bonus_Dex;
	...
	FUNC VOID Equip_firering()
	{
		Npc_ChangeAttribute(self,ATR_DEXTERITY,5 );
	};


	FUNC VOID UnEquip_firering()
	{
		Npc_ChangeAttribute(self,ATR_DEXTERITY,-5 );
	};
...
//Zadanie z Rockym 	
//******************************************************
INSTANCE ItQt_SwordsPack (C_Item)
{
	name 				=	"Paczka z broni¹";
	...
	scemeName			=	"MAPSEALED";	
	on_state[0]			=	UseIronPack;
	
	description			= name;
	TEXT[1]				= "Paczka mia³a";
	TEXT[2]				= "trafiæ do";
	TEXT[3]				= "Starej Kopalni.";
	TEXT[4]				= NAME_Value;					COUNT[4]	= value;
};
func void UseIronPack()
{
