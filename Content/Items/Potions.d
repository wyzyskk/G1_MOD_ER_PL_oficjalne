...
// Heilung
//edit by Nocturn
const int	Value_HpEssenz			=	35;		const int	HP_Essenz			=	50;
const int	Value_HpExtrakt			=	50;		const int	HP_Extrakt			=	70;
const int	Value_HpElixier			=	75;		const int	HP_Elixier			=	100;
const int	Value_HpFull			=	200;
...
const int	Value_ElixierEgg		=	500;		const int	ManaMax_ElixierEgg	=	10;	// FIXME: was wenn der SC das selbst benutzt??

const int	Value_StrEssenz			=	500;	const int	STR_Essenz			=	2;
const int	Value_StrExtrakt		=	1000;	const int	STR_Extrakt			=	3;
const int	Value_StrElixier		=	1500;	const int	STR_Elixier			=	4;

const int	Value_DexEssenz			=	500;	const int	DEX_Essenz			=	2;
const int	Value_DexExtrakt		=	1000;	const int	DEX_Extrakt			=	4;
const int	Value_DexElixier		=	1500;	const int	DEX_Elixier			=	6;
