...
func void B_Story_FMTaken()
{
	...
	B_ChangeGuild    (Grd_283_Gardist,GIL_NONE);  
	B_SetPermAttitude	(Grd_283_Gardist,	ATT_NEUTRAL);	
	Wld_InsertNpc		(Grd_285_Gardist,	"FMC_ENTRANCE");	//FMC-Guard(Mineneingang)	
	B_ChangeGuild    (Grd_285_Gardist,GIL_NONE);  
	B_SetPermAttitude	(Grd_285_Gardist,	ATT_NEUTRAL);	
	B_ExchangeRoutine	(Grd_201_Jackal,	"FMTaken");			//FMC-Guard(Mineneingang)
	var c_npc Jackal_FM;
	Jackal_FM.guild = GIL_NONE; Jackal_FM = Hlp_GetNpc (Grd_201_Jackal);
	B_ChangeGuild    (Jackal_FM,GIL_NONE);  
	B_SetPermAttitude	(Jackal_FM,	ATT_NEUTRAL);
	Jackal_FM.attribute[ATR_STRENGTH] = 150;
	Jackal_FM.attribute[ATR_DEXTERITY] = 150;
	Jackal_FM.attribute[ATR_HITPOINTS_MAX]= 750;
	Jackal_FM.attribute[ATR_HITPOINTS] 	= 750;
	Npc_SetTalentSkill (Grd_201_Jackal, NPC_TALENT_CROSSBOW,2);	
	CreateInvItems	(self, Itminugget, 500);
	
	//problemy
	/*Wld_InsertNpc	(GRD_2601_Gardist,"FMC_HUT11_OUT");
	Wld_InsertNpc	(GRD_2602_Gardist,"FMC_HUT11_OUT");
	Wld_InsertNpc	(GRD_2603_Gardist,"FMC_HUT11_OUT");
	Wld_InsertNpc	(GRD_2604_Gardist,"FMC_HUT11_OUT");
	Wld_InsertNpc	(GRD_2605_Gardist,"FMC_HUT11_OUT");
	Wld_InsertNpc	(GRD_2606_Gardist,"FMC_HUT11_OUT");
	Wld_InsertNpc	(GRD_2607_Gardist,"FMC_HUT11_OUT");
	Wld_InsertNpc	(GRD_2608_Gardist,"FMC_HUT11_OUT");
	Wld_InsertNpc	(GRD_2609_Gardist,"FMC_HUT11_OUT");
	B_ExchangeRoutine	(STT_313_Schatten,	"FMTaken");
	Wld_InsertNpc	(Stt_2610_Schatten,"FMC_HUT11_OUT");
	Wld_InsertNpc	(Stt_2611_Schatten,"FMC_HUT11_OUT");*/
