...
FUNC void  Grd_277_Gardist_SITTINGORK_Info()
{
	...
	AI_Output (self, other,"Grd_277_Gardist_SITTINGORK_Info_06_02"); //To nasz jeniec. Ma sukinsyn szczêœcie, ¿e pêk³o ko³o zêbate w rozdrabniaczu. Dlatego mo¿e sobie trochê odpocz¹æ.
	AI_Output (self, other,"Grd_277_Gardist_SITTINGORK_Info_06_03"); //Ale jak tylko naprawimy rozdrabniacz, skoñcz¹ siê ³ajdakowi wakacje!
};  
/*------------------------------------------------------------------------
							WORKINGORK							
------------------------------------------------------------------------*/
...
instance  Grd_277_Gardist_WORKINGORK (C_INFO)
{
	...
	important		= 0;
	permanent		= 0;
	description		= "Widzê, ¿e rozdrabniacz jest ju¿ sprawny."; 
};
...
{
	AI_Output (other, self,"Grd_277_Gardist_WORKINGORK_Info_15_01"); //Widzê, ¿e rozdrabniacz jest ju¿ sprawny.
