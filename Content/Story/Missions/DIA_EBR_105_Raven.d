...
{
    AI_Output (other, self ,"DIA_Raven_ZniewolonyAlex_15_01"); //Ponoæ zniewoli³eœ myœliwego.
    AI_Output (self, other ,"DIA_Raven_ZniewolonyAlex_03_02"); //Ten g³upiec nie chce wspó³pracowaæ ze Starym Obozem.

    AI_Output (other, self ,"DIA_Raven_ZniewolonyAlex_15_03"); //Czego od niego chcesz?
    AI_Output (self, other ,"DIA_Raven_ZniewolonyAlex_03_04"); //Chcieliœmy nawi¹zaæ korzystn¹ dla obu stron relacjê handlow¹.
    AI_Output (self, other ,"DIA_Raven_ZniewolonyAlex_03_05"); //Jednak zostaliœmy potraktowani jak z³odzieje i oszuœci!
    AI_Output (self, other ,"DIA_Raven_ZniewolonyAlex_03_06"); //Pewnie przybywasz, ¿eby go uwolniæ.
...
INSTANCE DIA_Raven_ZaplataZaWolnosc (C_INFO)
{
   ...
   permanent	= FALSE;
   description	= "Chcê, ¿ebyœ go wypuœci³. (1000 bry³ek rudy)";
};
