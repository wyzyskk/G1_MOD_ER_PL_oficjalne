...
INSTANCE DIA_Yberion_MessengerStartInfo (C_INFO)
{
   ...
   permanent	= FALSE;
   description	= "Przychodzê w sprawie pos³añca Œni¹cego.";
};
...
{
    AI_Output (other, self ,"DIA_Yberion_MessengerStartInfo_15_01"); //Mistrzu, przysy³a mnie Lester. Przychodzê w sprawie pos³añca Œni¹cego.
    AI_Output (self, other ,"DIA_Yberion_MessengerStartInfo_03_02"); //Dost¹pisz wielkiego zaszczytu. 
    AI_Output (other, self ,"DIA_Yberion_MessengerStartInfo_15_03"); //O czym mówisz, Mistrzu?
    AI_Output (self, other ,"DIA_Yberion_MessengerStartInfo_03_04"); //Jeden z naszych Guru ujrza³ w wizji niezwyk³¹ zapowiedŸ. 
    AI_Output (other, self ,"DIA_Yberion_MessengerStartInfo_15_05"); //ZapowiedŸ czego?
    AI_Output (self, other ,"DIA_Yberion_MessengerStartInfo_03_06"); //Cierpliwoœci. Daj mi skoñczyæ.
    AI_Output (self, other ,"DIA_Yberion_MessengerStartInfo_03_07"); //Ujrza³ zapowiedŸ przybycia pos³añca Œni¹cego. To w³aœnie On mo¿e nam daæ wskazówki dotycz¹ce przywo³ania Œni¹cego.
    AI_Output (self, other ,"DIA_Yberion_MessengerStartInfo_03_08"); //Cor Kalom boryka siê z wielkim problemem. Wydzielina pe³zaczy jest zbyt s³aba, aby rytua³ przywo³ania przebieg³ pomyœlnie.
    AI_Output (self, other ,"DIA_Yberion_MessengerStartInfo_03_09"); //Pos³aniec mo¿e nam daæ odpowiedŸ czym zast¹piæ wydzielinê. 
   // AI_Output (self, other ,"DIA_Yberion_MessengerStartInfo_03_10"); //Widzê, ¿e masz bystry rozum. 
    AI_Output (other, self ,"DIA_Yberion_MessengerStartInfo_15_11"); //Co musimy zrobiæ, aby go przywo³aæ? 
    AI_Output (self, other ,"DIA_Yberion_MessengerStartInfo_03_12"); //Nasz Guru w swojej wizji widzia³ stó³ ofiarny z ró¿nymi przedmiotami. Sam pos³aniec by³ ma³o widoczny choæ mo¿na by³o wyczuæ jego duchow¹ obecnoœæ.
    AI_Output (self, other ,"DIA_Yberion_MessengerStartInfo_03_13"); //Guru spisa³ listê przedmiotów ze sto³u ofiarnego. Bêd¹ one potrzebne do odprawienia rytua³u przywo³ania magicznego Pos³añca.
    AI_Output (self, other ,"DIA_Yberion_MessengerStartInfo_03_14"); //I to ty m³odzieñcze bêdziesz mia³ zaszczyt je zebraæ. Nastêpnie udasz siê do Cor Kaloma - on powie ci co dalej. Oto lista.
    AI_Output (other, self ,"DIA_Yberion_MessengerStartInfo_15_15"); //Zbiorê co trzeba i udam siê do Kaloma.
    AI_Output (self, other ,"DIA_Yberion_MessengerStartInfo_03_16"); //Pamiêtaj, ¿e nie ominie ciê nagroda zarówno duchowa jak i materialna.
	
	B_LogEntry(CH2_MessengerRecall,"Y'Berion wyjaœni³ mi, ¿e jeden z Guru doœwiadczy³ wizji, w której objawi³ mu siê rytua³ przywo³ania pos³añca Œni¹cego. Ta magiczna istota mo¿e daæ Bractwu odpowiedzi na pytania zwi¹zane z wielkim przywo³aniem Œni¹cego. Da³ mi listê rzeczy, które muszê zdobyæ i zanieœæ do Kaloma.");
...
func void Info_YBerion_BringFocus_OK ()
{
	...
	B_LogEntry                     (CH1_PSIcampWORK,"Dosta³em siê do Y'Beriona. Zleci³ mi odnalezienie kamienia ogniskuj¹cego.");
};
...
INSTANCE DIA_Yberion_MustMix (C_INFO)
{
   ...
   permanent	= FALSE;
   description	= "Musisz zmusiæ Nowicjusza Caine'a do sporz¹dzenia mikstury.";
};
...
{//1.24 fixed
    AI_Output (other, self ,"DIA_Yberion_MustMix_15_01"); //Musisz zmusiæ Nowicjusza Caine'a do sporz¹dzenia mikstury.
    AI_Output (other, self ,"DIA_Yberion_MustMix_15_02"); //Myœliwy Claw zosta³ silnie zatruty, a nikt z twoich ludzi nie chce mi pomóc.
    AI_Output (other, self ,"DIA_Yberion_MustMix_15_03"); //Caine ¿¹da one mnie du¿ej iloœci rudy.
    AI_Output (other, self ,"DIA_Yberion_MustMix_15_04"); //Przecie¿ przys³u¿y³em siê Bractwu. Myœliwi z pewnoœci¹ te¿ wiele razy wam pomogli.
...
FUNC VOID DIA_Yberion_KASADZIADU_Info()
{
    ...
    AI_Output (other, self ,"DIA_Yberion_KASADZIADU_15_02"); //Obieca³eœ 2000 bry³ek rudy Bandytom.
    AI_Output (self, other ,"DIA_Yberion_KASADZIADU_03_03"); //Ach, tak. Zapomnia³em. WeŸ je, Bandyto.
    CreateInvItems (self, ItMiNugget, 2000);
    B_GiveInvItems (self, other, ItMiNugget, 2000);
    B_LogEntry                     (CH1_PSIcampWORK,"Uda³o siê, otrzyma³em rudê. Teraz mogê siê nieco rozejrzeæ.");
