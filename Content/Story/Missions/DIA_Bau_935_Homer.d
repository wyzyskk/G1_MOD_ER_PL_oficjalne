...
INSTANCE DIA_Homer_PopieraszBunt (C_INFO)
{
   ...
   permanent	= FALSE;
   description	= "Jesteœ lojalny wobec Ry¿owego Ksiêcia?";
};
...
{
    AI_Output (other, self ,"DIA_Homer_PopieraszBunt_15_01"); //Jesteœ lojalny wobec Ry¿owego Ksiêcia?
    AI_Output (self, other ,"DIA_Homer_PopieraszBunt_03_02"); //Nie bywam zbyt czêsto na dole, ale tak. Ciê¿ko pracowa³em nad t¹ tam¹. Ry¿owy Ksi¹¿e jako jedyny mnie docenia.
    AI_Output (self, other ,"DIA_Homer_PopieraszBunt_03_03"); //A czemu pytasz? Przysy³a ciê Lewus.
	AI_Output (other, self ,"DIA_Homer_PopieraszBunt_15_04"); //Hmm... Tak...
	AI_Output (self, other ,"DIA_Homer_PopieraszBunt_03_05"); //Czy on w koñcu zrozumie, ¿e nikt ju¿ siê nie nabiera na te jego sztuczki? Co za cz³owiek...
	
	B_LogEntry                     (CH1_BuntZbieraczy,"Homer jest zwolennikiem Ry¿owego Ksiêcia, gdy¿ ten docenia jego pracê w³o¿on¹ w budowê tamy.");
	B_GiveXP (150);
    //Info_ClearChoices		(DIA_Homer_PopieraszBunt);
    //Info_AddChoice		(DIA_Homer_PopieraszBunt, "Jesteœ lojalny wobec Ry¿owego Ksiêcia?", DIA_Homer_PopieraszBunt_lOJALNY);
...
{
    AI_Output (other, self ,"DIA_Homer_PopieraszBunt_lOJALNY_15_01"); //Jesteœ lojalny wobec Ry¿owego Ksiêcia?
    AI_Output (self, other ,"DIA_Homer_PopieraszBunt_lOJALNY_03_02"); //Tak. Dobrze mnie traktuje.
    B_LogEntry                     (CH1_BuntZbieraczy,"Homer to przydupas Ry¿owego Ksiêcia. Z pewnoœci¹ powiedzia³by mu o wszystkim.");
...
FUNC VOID DIA_Homer_PopieraszBunt_PAPLA()
{
    ...
    AI_Output (other, self ,"DIA_Homer_PopieraszBunt_PAPLA_15_03"); //Rufus planuje akcjê. Chce, abym zakrad³ siê w nocy i zabi³ tego spaœlaka.
    AI_Output (other, self ,"DIA_Homer_PopieraszBunt_PAPLA_15_04"); //Zbieracze zajm¹ siê Lewusem i jego ludŸmi.
    AI_Output (self, other ,"DIA_Homer_PopieraszBunt_PAPLA_03_05"); //A wiêc to tak...
    AI_Output (self, other ,"DIA_Homer_PopieraszBunt_PAPLA_03_06"); //Dziêki za informacje...
    AI_Output (other, self ,"DIA_Homer_PopieraszBunt_PAPLA_15_07"); //Czyli jesteœ z nami?
    AI_Output (self, other ,"DIA_Homer_PopieraszBunt_PAPLA_03_08"); //Tak, tak. Muszê ju¿ iœæ.
