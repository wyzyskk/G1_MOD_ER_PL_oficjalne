...
instance  DIA_Balor_FetchWeed (C_INFO)
{
	...
	permanent	= 0;
	description	= "Mam dostarczyæ do obozu zebrane przez was ziele.";
};                       
...
func void DIA_Balor_TellDealer_Pay()
{
	...
	if (Npc_HasItems(hero, itminugget) >= 50)
	{
		...
		B_LogEntry			(GE_TraderNC,	"Jeden ze Szkodników w Nowym Obozie ponoæ skupuje wiêksze iloœci bagiennego ziela. Nazywa siê Cipher i czêsto przesiaduje w karczmie na œrodku jeziora.");//fix
	}
	else
	{
