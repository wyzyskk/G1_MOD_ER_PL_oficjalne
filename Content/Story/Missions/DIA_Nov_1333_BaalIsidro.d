...
INSTANCE DIA_BaalIsidro_Problem(C_INFO) 
{
	...
	permanent	= 0;
	description = "Masz nieŸle przechlapane.";
};                       
...
INSTANCE DIA_BaalIsidro_INTERESY (C_INFO)
{
   ...
   permanent	= FALSE;
   description	= "Prowadzisz mo¿e jakieœ interesy z Cyrusem?";
};
...
{
    AI_Output (other, self ,"DIA_BaalIsidro_INTERESY_15_01"); //Prowadzisz mo¿e jakieœ interesy z Cyrusem?
    ...
    AI_Output (self, other ,"DIA_BaalIsidro_INTERESY_03_07"); //Po prostu sprzedajê wszystko w Bractwie za tak¹ cenê jak¹ oferuje mu Stary Obóz. Tutaj wszystko jest tañsze.
    AI_StopProcessInfos	(self);
};
...
INSTANCE DIA_BaalIsidro_NAPASC (C_INFO)
{
   ...
   permanent	= FALSE;
   description	= "Pos³uchaj: Szkodniki chc¹ ciê napaœæ!";
};
...
{
    AI_Output (other, self ,"DIA_BaalIsidro_NAPASC_15_01"); //Pos³uchaj: Szkodniki chc¹ ciê napaœæ!
    AI_Output (self, other ,"DIA_BaalIsidro_NAPASC_03_02"); //Co? Niby czemu?
    AI_Output (other, self ,"DIA_BaalIsidro_NAPASC_15_03"); //Pods³ucha³em ich rozmowê. Twierdz¹, ¿e sprzedajesz im lewe ziele.
    AI_Output (self, other ,"DIA_BaalIsidro_NAPASC_03_04"); //Cholera. Mo¿e rzeczywiœcie komuœ coœ Ÿle da³em. Ostatnio nieŸle zapi³em.
