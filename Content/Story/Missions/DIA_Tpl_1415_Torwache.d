...
FUNC VOID DIA_Tpl_1415_Torwache_First_Info()
{
	...
	Info_AddChoice		(DIA_Tpl_1415_Torwache_First,"Chcia³bym rozejrzeæ siê trochê po waszym Obozie.",DIA_Tpl_1415_Torwache_First_JustLooking);
...
{
    AI_Output (other, self ,"DIA_Templer_WhoYou_15_01"); //Kim jesteœ?
    AI_Output (self, other ,"DIA_Templer_WhoYou_03_02"); //Nazywam siê Gor Na Tan, pilnujê bramy.
    AI_Output (self, other ,"DIA_Templer_WhoYou_03_03"); //Pilnujê Obozu przed bestiami przybywaj¹cymi z lasu, oraz rozmaitymi bandytami. Kolonia Karna to niebezpieczne miejsce. Ty te¿ powinieneœ mieæ siê na bacznoœci. 

    AI_Output (other, self ,"DIA_Templer_WhoYou_15_04"); //Bêdê pamiêta³.
};
...
FUNC VOID DIA_Templer_Trader_Info()
{
    ...
    AI_Output (self, other ,"DIA_Templer_Trader_03_03"); //Uwa¿a, ¿e przybli¿aj¹c nowym nasz¹ kulturê i zwyczaje, przekonamy ich do wiary w Œni¹cego.
    AI_Output (other, self ,"DIA_Templer_Trader_15_04"); //Myœlê, ¿e wiara i zwyczaje to dwie ró¿ne rzeczy.
    AI_Output (self, other ,"DIA_Templer_Trader_03_05"); //To prawda, jednak to nie moja decyzja, tylko Cor Kaloma.
    AI_Output (self, other ,"DIA_Templer_Trader_03_06"); //To bardzo oddany Œni¹cemu cz³owiek, który zrobi wszystko, ¿eby go przebudziæ.
