...
func void Info_SLD_732_FirstWarn_Info()
{
	...
	AI_Output 		(self, hero,"Info_SLD_732_FirstWarn_08_01"); //STAÆ! Nikt nie przejdzie bez podania has³a.
...
func void Info_SLD_732_Parole_CRONOS ()
{
	...
	AI_Output 			(self, hero,"Info_SLD_732_Parole_CRONOS_08_02"); //W takim wypadku poda³by ci równie¿ has³o. ZejdŸ mi z oczu, k³amco.
	AI_StopProcessInfos	(self);
};
...
func void Info_SLD_732_Parole_FORGOT ()
{
	...
	AI_Output 			(self, hero,"Info_SLD_732_Parole_FORGOT_08_02"); //To wróæ, jak tylko sobie przypomnisz i przestañ zawracaæ mi g³owê!
	AI_StopProcessInfos	(self);
};
...
func void Info_SLD_732_Parole_TRUE ()
{
	...
	AI_Output 			(self, hero,"Info_SLD_732_Parole_TRUE_08_02"); //Zgadza siê. Mo¿esz przejœæ.
	AI_StopProcessInfos	(self);
...
{
	AI_Output 		(self, hero,"Info_SLD_732_LastWarn_08_01"); 		//Nie bêdê siê powtarza³. ANI KROKU DALEJ!
