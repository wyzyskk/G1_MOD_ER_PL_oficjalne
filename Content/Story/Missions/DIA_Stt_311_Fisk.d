...
{
    AI_Output (other, self ,"DIA_Fisk_OfertaOdMila_15_01"); //Mam dla ciebie ofertê.
    AI_Output (self, other ,"DIA_Fisk_OfertaOdMila_03_02"); //S³ucham ciê wiêc.
    AI_Output (other, self ,"DIA_Fisk_OfertaOdMila_15_03"); //Ten p³aszcz musi trafiæ w rêce Magnata Blizny.
    AI_Output (self, other ,"DIA_Fisk_OfertaOdMila_03_04"); //Hmmm. Móg³bym na tym sporo zarobiæ. Ten p³aszcz jest warty... hmmm... 300 bry³ek rudy.
    AI_Output (self, other ,"DIA_Fisk_OfertaOdMila_03_05"); //Ale jako, ¿e nie mogê go sprzedaæ komu zechcê, muszê potr¹ciæ ci czêœæ jego wartoœci.
    ...
    //Info_AddChoice		(DIA_Fisk_OfertaOdMila, "Wrócê póŸniej.", DIA_Fisk_OfertaOdMila_BACK);
    Info_AddChoice		(DIA_Fisk_OfertaOdMila, "Dobra. Dawaj rudê i bierz ten p³aszcz.", DIA_Fisk_OfertaOdMila_BIERZ_PLASZCZ);
...
FUNC VOID DIA_Fisk_OfertaOdMila_NIE_OKEJ()
{
    ...
    AI_Output (self, other ,"DIA_Fisk_OfertaOdMila_NIE_OKEJ_03_02"); //Nie znajdziesz lepszej oferty w okolicy, ale có¿.
    Info_ClearChoices		(DIA_Fisk_OfertaOdMila);
    AI_StopProcessInfos	(self);
	DIA_Fisk_OfertaOdMila.permanent = false;
};
...
FUNC VOID DIA_Fisk_HowAreYou_Info()
{
    ...
    AI_Output (self, other ,"DIA_Fisk_HowAreYou_03_02"); //Ca³kiem nieŸle. Odk¹d opuœci³em Stary Obóz w koñcu czujê siê wolny.
    AI_Output (other, self ,"DIA_Fisk_HowAreYou_15_03"); //Interes pewnie nie za dobrze siê teraz krêci?
    AI_Output (self, other ,"DIA_Fisk_HowAreYou_03_04"); //Mo¿e i bêdê mia³ mniej klientów ni¿ w Starym Obozie, ale nie troszczê siê o to.
    AI_Output (self, other ,"DIA_Fisk_HowAreYou_03_05"); //W Obozie mia³em masê k³opotów.
};
