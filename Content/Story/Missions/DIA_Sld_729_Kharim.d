...
func void Info_Kharim_Charge_Insult()
{
	...
	Info_AddChoice		(Info_Kharim_Charge,"Nie, nie przychodzi mi do g³owy nic, co by³byœ w stanie zrozumieæ."				,Info_Kharim_Charge_Insult_Stupid);
	...
	//Info_AddChoice		(Info_Kharim_Charge,"Twój stary jest tak stary, ¿e wisi Adanosowi 5 sztuk z³ota."						,Info_Kharim_Charge_Insult_Father);
	//Info_AddChoice		(Info_Kharim_Charge,"Zaraz przywalê ci w ten koñski ryj"												,Info_Kharim_Charge_Insult_HorseFace);
	Info_AddChoice		(Info_Kharim_Charge,"Dobra, spokojnie. Zapomnijmy o ca³ej sprawie!"										,Info_Kharim_Charge_BACK);
...
{
	AI_Output (other, self,"Info_Kharim_Charge_Insult_Father_15_00"); //Twój stary jest tak stary, ¿e wisi Adanosowi 5 sztuk z³ota.
	AI_Output (self, other,"Info_Kharim_Charge_Insult_Father_09_01"); //Ha ha ha. Rozbawi³eœ mnie. Ha ha ha. Gdzie to s³ysza³eœ?
	AI_Output (self, other,"Info_Kharim_Charge_Insult_Father_09_02"); //Widzê, ¿e bardzo chcesz siê ze mn¹ biæ.
	AI_Output (self, other,"Info_Kharim_Charge_Insult_Father_09_03"); //ChodŸmy zatem. 
