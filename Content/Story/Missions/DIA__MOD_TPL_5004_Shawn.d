...
{
    AI_Output (self, other ,"DIA_Shawn_HELLO_03_01"); //Witaj, przybyszu! Nazywam siê Gor Na Dhun, pokorny s³uga Œni¹cego.
...
FUNC VOID DIA_Shawn_QUEST1_Info()
{
    ...
    B_LogEntry               (CH1_UciekinierPC,"Gor Na Dhun kaza³ mi znaleŸæ z³odzieja, który w³ama³ siê do œwi¹tyni podczas rytua³u przywo³ania i ukrad³ kostur Y'Beriona. Rabuœ wypad³ ze œwi¹tyni jak oszala³y. Z pewnoœci¹ potr¹ci³ kogoœ na placu. Tam powinienem szukaæ wskazówek.");
};
//========================================
//-----------------> QUEST1_WIN
//========================================
...
FUNC VOID DIA_QUEST1_QUEST1_WIN_Info()
{
    ...
    B_LogEntry           (CH1_UciekinierPC,"Odda³em skradziony kostur Gor Na Dhunowi. On dopilnuje, by broñ zosta³a zabezpieczona razem z cia³em Y'Beriona.");
...
FUNC VOID DIA_Shawn_QUEST2_Info()
{
    ...
    B_LogEntry               (CH1_HandlarzSteh,"Gor Na Dhun kaza³ mi odkryæ kto w Obozie prowadzi badania nad bagnem. Wskazówk¹ jest to, ¿e osoba handluje poszukiwanymi przez Y'Beriona przedmiotami.");
};
...
FUNC VOID DIA_Shawn_QUEST2_WIN_Info()
{
    ...
    B_LogEntry               (CH1_HandlarzSteh,"Powiedzia³em Gor Na Dhunowi o mojej rozmowie ze Stehem. By³ zadowolony, ale jednoczeœnie zaniepokojony. Widocznie sta³o siê coœ z³ego.");
...
FUNC VOID DIA_Shawn_KILLTOOL_Info()
{
    ...
    B_LogEntry                     (CH1_SeryjneZabojstwa,"Pokaza³em narzêdzia zbrodni Gor Na Dhunowi. Powiedzia³ mi, ¿ebym sprawdzi³ Hansona, poniewa¿ tylko on pracuje w tartaku.");
};
...
FUNC VOID DIA_Shawn_QUEST3_OK_Info()
{
    ...
    B_LogEntry               (CH1_SeryjneZabojstwa,"Opowiedzia³em Gor Na Dhunowi o Hansonie. Okazuje siê, ¿e sytuacja w Obozie robi siê coraz mniej ciekawa. Aby zapobiec kolejnym incydentom Gor Na Dhun porozmawia z pozosta³ymi Guru.");
...
FUNC VOID DIA_Shawn_POSZUKIWACZE_Info()
{
    ...
    B_LogEntry                     (CH1_MroczneBractwo,"Gor Na Dhun obawia siê tego, który rzekomo zleci³ Hansonowi zabójstwo. To coœ mo¿e byæ dla nas zagro¿eniem.");
...
FUNC VOID DIA_Shawn_QUEST4_Info()
{
    ...
    B_LogEntry                     (CH1_ListDoCronosa,"Gor Na Dhun da³ mi list, który muszê wrêczyæ Cronosowi w Nowym Obozie.");
};
//========================================
//-----------------> HELLO2
//========================================
...
FUNC VOID DIA_Shawn_HELLO2_Info()
{
    ...
    if (Npc_HasItems (other, NotatkiAlchemika) >=1)
    {
        ...
        B_LogEntry                     (CH1_PoszukiwanaAlchemika,"Odda³em Gor Na Dhunowi notatki, które znalaz³em na bagnie. Najpewniej nale¿a³y do alchemika.");
    ...
    B_LogEntry                     (CH1_PoszukiwanaAlchemika,"Rzomawia³em z Gor Na Dhunem o moim znalezisku z bagna. Notaki alchemika wykaza³y, ¿e uda³ siê on na Cmentarzysko Orków. Nie mam zamiaru tam iœæ w najbli¿yszm czasie.");
    AI_StopProcessInfos	(self);
};
...
FUNC VOID DIA_Shawn_QuestsBractwo2_Info()
{
    ...
    B_LogEntry                     (CH1_PoszukiwanaAlchemika,"Gor Na Dhun kaza³ mi odnaleŸæ starego alchemika, który przeprowadza³ dla Bractwa badania nad bagnem.");
    AI_StopProcessInfos	(self);
};
...
FUNC VOID DIA_Shawn_TalkAboutStones_Info()
{
    ...
    if (Npc_KnowsInfo (hero, DIA_OldAlchemyMan_HELLO4))
    {
        ...
        B_LogEntry                     (CH1_PoszukiwanaAlchemika,"Gor Na Dhun by³ zadowolony, gdy pozna³ wyniki badañ alchemika. Szkoda, ¿e on sam nie móg³ o nich opowiedzieæ.");
...
FUNC VOID DIA_Shawn_QuestCH3_Info()
{
    ...
    B_LogEntry                     (CH1_SellElixer,"Gor Na Dhun kaza³ mi odkryæ kto nielegalnie sprzedaje eliksir z wnêtrznoœci pe³zaczy. Prawdopodobnie towar w ca³oœci idzie do Nowego Obozu.");
    AI_StopProcessInfos	(self);
...
FUNC VOID DIA_Shawn_SellElixirCaine_Info()
{
    ...
    B_LogEntry                     (CH1_SellElixer,"Wyda³em Caine'a Gor Na Dhunowi. Nie ma litoœci dla takiego postêpowania!");
...
FUNC VOID DIA_Shawn_Questdadasd_Info()
{
    ...
    B_LogEntry                     (CH1_HelpBrothersBra,"Gor Na Dhun kaza³ mi sprawdziæ co sta³o siê z naszymi braæmi ze Starej Kopalni.");
};
...
FUNC VOID DIA_Shawn_Uwolnieni_Info()
{
    ...
    B_LogEntry                     (CH1_HelpBrothersBra,"Przekaza³em Gor Na Dhunowi informacje o wydarzeniach z Kolonii. Przy okazji zosta³em wynagrodzony za uwolnienie braci z kopalni.");
...
FUNC VOID DIA_Shawn_BAN_THREAD_Info()
{
    ...
    if FMTaken
    {
        ...
        if (Npc_KnowsInfo (hero, DIA_Drax_Ded)) && (MIS_Do_lowcow == LOG_SUCCESS)
        {
			...
			go_help_torlof = true;
			B_LogEntry                     (CH1_Watek_Bandytow_BRACTWO,"Od Gor Na Dhuna nie dowiedzia³em siê nic nowego. Sytuacja w Kolonii jest kiepska. Moim zadaniem by³o wsparcie Bandytów w ich dzia³aniach. Uprzedzi³em polecenie Gor Na Dhuna i ju¿ to zrobi³em. Teraz muszê iœæ do Nowego Obozu i pomóc Najemnikom w walce ze Stra¿nikami.");
        }
        else
        {
            AI_Output (self, other ,"DIA_Shawn_BAN_THREAD_03_17"); //No dobrze. Pójdê z nim pogadaæ.
			second_d_shawn = true;
			B_LogEntry                     (CH1_Watek_Bandytow_BRACTWO,"Gor Na Dhun martwi siê sytuacj¹ w Kolonii. Muszê pogadaæ z Bandyt¹ Draxem, który ponoæ planuje jakiœ atak na patrole Gomeza.");
