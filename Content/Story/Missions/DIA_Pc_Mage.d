...
func VOID DIA_Milten_GotoCorristo_Info()
{
	if ( (Npc_HasItems(other,ItWr_Fire_Letter_01)>=1) || (Npc_HasItems(other,ItWr_Fire_Letter_02)>=1) )
	{
		...
		B_LogEntry               (CH1_Massage,"Odda³em list do Magów Ognia Miltenowi, którego spotka³em przed ich œwi¹tyni¹. W sumie niczego konkretnego siê nie dowiedzia³em. Nie dosta³em te¿ ¿adnej nagrody.");
...
INSTANCE DIA_PC_MAGE_DziwnyKamien (C_INFO)
{
   ...
   permanent	= FALSE;
   description	= "Znalaz³em dziwny kamieñ.";
};
...
{
    AI_Output (other, self ,"DIA_PC_MAGE_DziwnyKamien_15_01"); //Znalaz³em dziwny kamieñ.
    AI_Output (self, other ,"DIA_PC_MAGE_DziwnyKamien_03_02"); //To Kamieñ Wiedzy. Nareszcie ktoœ go odnalaz³. Wyznaczy³em za niego nagrodê. 
    AI_Output (self, other ,"DIA_PC_MAGE_DziwnyKamien_03_03"); //300 bry³ek rudy. 
    AI_Output (other, self ,"DIA_PC_MAGE_DziwnyKamien_15_04"); //Znalaz³em go przy opêtanym Kopaczu.
    AI_Output (other, self ,"DIA_PC_MAGE_DziwnyKamien_15_05"); //Jim wypytywa³ mnie o to, czy znalaz³em coœ przy o³tarzu, który mia³em oczyœciæ. O nagrodzie nie wspomnia³... Pewnie liczy³ na to, ¿e po prostu mu go oddam, a on sprzeda mi jakaœ kiepsk¹ wymówkê.
    AI_Output (self, other ,"DIA_PC_MAGE_DziwnyKamien_03_06"); //Na pewno nie mia³ nic z³ego na myœli.
    AI_Output (other, self ,"DIA_PC_MAGE_DziwnyKamien_15_07"); //Taaa... Jasne...
    CreateInvItems (self, ItMiNugget, 300);
    B_GiveInvItems (self, other, ItMiNugget, 300);
    B_LogEntry                     (CH1_Fire_Novize,"Jim chcia³ mnie oszukaæ, zabraæ mi Kamieñ Wiedzy i odebraæ nagrodê od Miltena. Ca³e szczêœcie, ¿e mu go nie da³em. ");
...
func void DIA_Milten_Letter_Give()
{
	...
	Log_SetTopicStatus   (CH1_Massage, LOG_SUCCESS);
    B_LogEntry               (CH1_Massage,"Odda³em list do Magów Ognia Miltenowi, którego spotka³em przed ich œwi¹tyni¹. Podobno zaadresowany by³ do jakiegoœ Xardasa, który dawno temu przesta³ byæ s³ug¹ Innosa i zamieszka³ w wie¿y na Terytorium Orków. Milten odda³ list Corristo, który poleci³ mi udaæ siê Torreza po nagrodê.");
	};
...
func VOID DIA_Milten_NochEinBrief_Info()
{
	...
	B_LogEntry               (CH1_KdWCourier,"Odda³em list Cronosa Magom Ognia. Powinienem wróciæ do Nowego Obozu po nagrodê.");
...
instance Info_Milten_SHSCROLL (C_INFO)
{
	...
	important	= 0;
	permanent	= 0;
	description	= "Wykorzysta³em zwój, ale niestety nie na Stra¿niku!";
};
...
{
    AI_Output (self, other ,"DIA_PC_MAGE_HelloFromHunters_03_01"); //Znowu siê spotykamy!
    AI_Output (other, self ,"DIA_PC_MAGE_HelloFromHunters_15_02"); //Co tu robisz?
    AI_Output (self, other ,"DIA_PC_MAGE_HelloFromHunters_03_03"); //Mam tu kilka spraw do za³atwienia z przywódc¹ ³owców. Potrzebujê kilku surowców.
    AI_Output (self, other ,"DIA_PC_MAGE_HelloFromHunters_03_04"); //Za kilka dni powinienem wróciæ do Starego Obozu. 
    AI_Output (other, self ,"DIA_PC_MAGE_HelloFromHunters_15_06"); //Rozumiem. Trzymaj siê. 
    AI_StopProcessInfos	(self);
};
...
INSTANCE DIA_PC_MAGE_SPOTKANIE (C_INFO)
{
   ...
   permanent	= FALSE;
   description	= "Diego prosi³, aby ciê zapytaæ czy stawisz siê na spotkanie.";
};
...
{
    AI_Output (other, self ,"DIA_PC_MAGE_SPOTKANIE_15_01"); //Diego prosi³, aby ciê zapytaæ czy stawisz siê na spotkanie.
    AI_Output (self, other ,"DIA_PC_MAGE_SPOTKANIE_03_02"); //Owszem, stawiê. Muszê zapomnieæ o tym koszmarze, który spotka³ moich braci.
    AI_Output (self, other ,"DIA_PC_MAGE_SPOTKANIE_03_03"); //Szczera rozmowa z przyjació³mi z pewnoœci¹ mi pomo¿e.
    AI_Output (other, self ,"DIA_PC_MAGE_SPOTKANIE_15_04"); //Œwietnie, w takim razie przeka¿ê dobr¹ wiadomoœæ Diego.
    B_LogEntry                     (CH4_4Friends,"Milten stawi siê na spotkanie. Trzeba poinformowaæ o tym Diego.");
...
{
    AI_Output (self, other ,"DIA_pc_mage_PODAREK_MILTEN_03_01"); //O, witaj przyjacielu. Widzê, ¿e Gorn zaprosi³ ciê na spotkanie.
    AI_Output (other, self ,"DIA_pc_mage_PODAREK_MILTEN_15_02"); //Zgadza siê, uwa¿a ¿e jestem godzien waszego zaufania.
	AI_Output (self, other ,"DIA_pc_mage_PODAREK_MILTEN_03_03"); //I ma racje, ju¿ wczeœniej planowaliœmy z Diego ciê zaprosiæ.
	AI_Output (self, other ,"DIA_pc_mage_PODAREK_MILTEN_03_04"); //Niestety, nigdy nie by³eœ w okolicy.
	AI_Output (other, self ,"DIA_pc_mage_PODAREK_MILTEN_15_05"); //W to akurat jestem sk³onny uwierzyæ.
	AI_Output (self, other ,"DIA_pc_mage_PODAREK_MILTEN_03_06"); //Wiesz, mam dla ciebie skromny podarek na znak przyjaŸni.
	AI_Output (self, other ,"DIA_pc_mage_PODAREK_MILTEN_03_07"); //WeŸ tê potê¿n¹ magiczn¹ runê. Znalaz³em je przypadkiem w œwi¹tyni Magów Ognia.
	AI_Output (self, other ,"DIA_pc_mage_PODAREK_MILTEN_03_08"); //Ukryta by³a pod ³ó¿kiem. Zgadujê, ¿e by³a w³asnoœci¹ Xardasa, zanim opuœci³ Kr¹g Ognia. 
    CreateInvItems (self, ItArRuneBreathOfDeath, 1);
    B_GiveInvItems (self, other, ItArRuneBreathOfDeath, 1);
	B_LogEntry                     (CH4_4Friends,"Milten da³ mi Tchnienie Œmierci. Najpotê¿niejsz¹ runê znan¹ Magom. ");
   // AI_StopProcessInfos	(self);
};
...
INSTANCE DIA_PC_MAGE_CORRISTO_LIVE (C_INFO)
{
   npc          = PC_MAGE;
   nr           = 3;
   condition    = DIA_PC_MAGE_CORRISTO_LIVE_Condition;
   information  = DIA_PC_MAGE_CORRISTO_LIVE_Info;
   permanent	= FALSE;
   description	= "Spotka³em Corristo na œcie¿ce do placu wymian.";
};

FUNC INT DIA_PC_MAGE_CORRISTO_LIVE_Condition()
{
    if (Npc_KnowsInfo (hero, DIA_pc_mage_PODAREK_MILTEN))
    && (Npc_KnowsInfo (hero, DIA_Corristo_Chapter4_NewStoryLine))
    {
    return TRUE;
    };
};
...
FUNC VOID DIA_PC_MAGE_CORRISTO_LIVE_Info()
{
    AI_Output (other, self ,"DIA_PC_MAGE_CORRISTO_LIVE_15_01"); //Spotka³em Corristo na œcie¿ce do placu wymian.
    AI_Output (other, self ,"DIA_PC_MAGE_CORRISTO_LIVE_15_02"); //Chcia³, abym przyniós³ mu artefakt z Opuszczonej Kopalni.
    AI_Output (self, other ,"DIA_PC_MAGE_CORRISTO_LIVE_03_03"); //CO? Corristo ¿yje? Ale jak...
    AI_Output (other, self ,"DIA_PC_MAGE_CORRISTO_LIVE_15_04"); //Ja te¿ nie wiem jakim cudem prze¿y³. Powiedzia³, ¿e uciek³ ze Starego Obozu.
    AI_Output (self, other ,"DIA_PC_MAGE_CORRISTO_LIVE_03_05"); //Na Innosa, jeœli to prawda, to muszê go odszukaæ.
    AI_Output (self, other ,"DIA_PC_MAGE_CORRISTO_LIVE_03_06"); //Mo¿e razem coœ wymyœlimy w sprawie Gomeza.
    AI_Output (self, other ,"DIA_PC_MAGE_CORRISTO_LIVE_03_07"); //Co jeszcze mo¿esz mi o nim powiedzieæ?
    AI_Output (other, self ,"DIA_PC_MAGE_CORRISTO_LIVE_15_08"); //Nic szczególnego. Rozmawialiœmy g³ównie o tym artefakcie.
    AI_Output (other, self ,"DIA_PC_MAGE_CORRISTO_LIVE_15_09"); //Po co mu on tak w³aœciwie?
    AI_Output (self, other ,"DIA_PC_MAGE_CORRISTO_LIVE_03_10"); //Nie mam pojêcia. Byæ mo¿e chce pomóc Magom Wody? 
    AI_Output (self, other ,"DIA_PC_MAGE_CORRISTO_LIVE_03_11"); //Jak go spotkam, z pewnoœci¹ dowiem siê o co chodzi.
};
...
INSTANCE DIA_PC_MAGE_PLANY (C_INFO)
{
   ...
   permanent	= FALSE;
   description	= "Co planujesz robiæ dalej?";
};
...
{
    AI_Output (other, self ,"DIA_PC_MAGE_PLANY_15_01"); //Co planujesz robiæ dalej?
   ...
   // AI_Output (self, other ,"DIA_PC_MAGE_PLANY_03_05"); //Wiesz, znam wiele planów i zamys³ów Gomeza.
   // AI_Output (self, other ,"DIA_PC_MAGE_PLANY_03_06"); //Pomogê ludziom z Nowego Obozu pozbyæ siê go na dobre.
   // AI_Output (other, self ,"DIA_PC_MAGE_PLANY_15_07"); //No i dobrze.
};
...
FUNC VOID DIA_PC_MAGE_RAVEN_Info()
{
   ...
   // AI_Output (other, self ,"DIA_PC_MAGE_RAVEN_15_06"); //Co mo¿esz mi powiedzieæ jeszcze o Kruku?
   // AI_Output (self, other ,"DIA_PC_MAGE_RAVEN_03_07"); //Zawsze by³ podejrzany. Nienawidzi³ mnie i moich braci. Du¿o czasu spêdza³ samotnie, nocami wychodzi³ i wraca³ nad ranem.
   // AI_Output (self, other ,"DIA_PC_MAGE_RAVEN_03_08"); //Moim zdaniem jest on o wiele bardziej niebezpieczny ni¿ Gomez.
   // AI_Output (self, other ,"DIA_PC_MAGE_RAVEN_03_09"); //Z pewnoœci¹ spotkasz go jeszcze na swojej drodze. Uwa¿aj na niego!
};
...
INSTANCE DIA_PC_MAGE_XAR (C_INFO)
{
   ...
   permanent	= FALSE;
   description	= "Czy zna³eœ Xardasa?";
};
...
{
    AI_Output (other, self ,"DIA_PC_MAGE_XAR_15_01"); //Czy zna³eœ Xardasa?
    AI_Output (self, other ,"DIA_PC_MAGE_XAR_03_02"); //Nie. Jedynie o nim s³ysza³em.
    AI_Output (self, other ,"DIA_PC_MAGE_XAR_03_03"); //Podobno by³ Arcymistrzem Magów Ognia przed Corristo, i to on dowodzi³ magami tworz¹cymi Barierê.
    AI_Output (self, other ,"DIA_PC_MAGE_XAR_03_04"); //Zwróci³ siê w stronê czarnej magii i odrzuci³ od siebie Innosa.
    AI_Output (self, other ,"DIA_PC_MAGE_XAR_03_05"); //Nie wiem co o tym wszystkim myœleæ. Xardas wydaje mi siê bardzo tajemnicz¹ osoba, która ma jakieœ tylko sobie znane plany.
    AI_Output (other, self ,"DIA_PC_MAGE_XAR_15_06"); //To znaczy?
    AI_Output (self, other ,"DIA_PC_MAGE_XAR_03_07"); //Nie wiem dok³adnie. ¯aden z wys³anych do niego zwiadowców nie wróci³.
    AI_Output (self, other ,"DIA_PC_MAGE_XAR_03_08"); //Nawet Magowie Wody próbowali siê z nim skontaktowaæ. Gorn mi o tym mówi³.
    AI_Output (self, other ,"DIA_PC_MAGE_XAR_03_09"); //Najlepiej nie mieszaæ siê w jego sprawy.
};
...
INSTANCE DIA_PC_MAGE_BEFORE_MAGE (C_INFO)
{
   ...
   permanent	= FALSE;
   description	= "Kim by³eœ zanim zosta³eœ Magiem Ognia?";
};
...
FUNC VOID DIA_PC_MAGE_BEFORE_MAGE_Info()
{
    ...
    AI_Output (self, other ,"DIA_PC_MAGE_BEFORE_MAGE_03_11"); //Widz¹c ogrom armii orków postanowi³em uciec na wyspê Khorinis.
    AI_Output (self, other ,"DIA_PC_MAGE_BEFORE_MAGE_03_12"); //Zamieszka³em wiêc w porcie, prowadz¹c proste ¿ycie.
    AI_Output (self, other ,"DIA_PC_MAGE_BEFORE_MAGE_03_13"); //Niestety brakowa³o dla mnie pracy, przez co czêsto k³ad³em siê spaæ z pustym ¿o³¹dkiem.
    AI_Output (self, other ,"DIA_PC_MAGE_BEFORE_MAGE_03_14"); //Bieda zmusi³a mnie do kradzie¿y. Musia³em coœ zjeœæ, by nie umrzeæ z g³odu.
   ...
   //jebaæ memoriusa! AI_Output (other, self ,"DIA_PC_MAGE_BEFORE_MAGE_15_17"); //Taa...
	...
	//PEDALSKIE 
   // AI_Output (self, other ,"DIA_PC_MAGE_BEFORE_MAGE_03_20"); //J Innos œwiadkiem, ¿e moi przyjaciele s¹ dla mnie wszystkim i nigdy ich nie zdradzê.
  //  AI_Output (other, self ,"DIA_PC_MAGE_BEFORE_MAGE_15_21"); //Ja te¿, przyjacielu. 
};
