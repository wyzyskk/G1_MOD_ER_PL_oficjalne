...
FUNC VOID DIA_GorNaBar_SZPIEG_Info()
{
    ...
    AI_Output (self, other ,"DIA_GorNaBar_SZPIEG_03_04"); //Pe³zacze robi¹ siê coraz bardziej agresywne.
    AI_Output (other, self ,"DIA_GorNaBar_SZPIEG_15_05"); //Czy Stra¿nicy pomagaj¹ wam zabijaæ pe³zacze?
    AI_Output (self, other ,"DIA_GorNaBar_SZPIEG_03_06"); //Do pewnego czasu pomagali nam, tylko gdy by³o im to na rêkê. 
    AI_Output (self, other ,"DIA_GorNaBar_SZPIEG_03_07"); //Teraz jednak chodz¹ z nami na polowania.
    AI_Output (self, other ,"DIA_GorNaBar_SZPIEG_03_08"); //To dosyæ dziwne. Odrywaj¹ pe³zaczom odnó¿a, po czym zanosz¹ do zwierzchników.
    AI_Output (self, other ,"DIA_GorNaBar_SZPIEG_03_09"); //Œcigaj¹ siê wrêcz w tym.
    AI_Output (self, other ,"DIA_GorNaBar_SZPIEG_03_10"); //S³ysza³em plotki o jakichœ pertraktacjach pomiêdzy Bractwem a Gomezem.
    AI_Output (self, other ,"DIA_GorNaBar_SZPIEG_03_11"); //Niestety nie wiem nic wiêcej.
    AI_Output (other, self ,"DIA_GorNaBar_SZPIEG_15_12"); //Kto móg³by wiedzieæ?
    AI_Output (self, other ,"DIA_GorNaBar_SZPIEG_03_13"); //Za piwo od Stra¿nika wyci¹gniesz wiele. Spróbuj delikatnie zapytaæ.
    B_LogEntry                     (CH1_PSIcampWORK,"Gor Na Bar zdradzi³ mi, ¿e Stra¿nicy zaczêli pomagaæ wys³annikom Bractwa podczas polowañ na pe³zacze. Dotychczas jednak tego nie czynili. Czy¿by na tym mia³aby polegaæ nowa wspó³praca miêdzy obozami? Muszê zasiêgn¹æ jêzyka wœród Stra¿ników.");
