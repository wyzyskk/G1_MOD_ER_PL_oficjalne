...
FUNC VOID DIA_Dusty_ABOUT_BONIE_Info()
{
    ...
    AI_Output (self, other ,"DIA_Dusty_ABOUT_BONIE_03_03"); //Skoro nie masz rudy, to lepiej nie idŸ dalej. To teren Bonie.
    AI_Output (other, self ,"DIA_Dusty_ABOUT_BONIE_15_04"); //Co z nim nie tak?
    AI_Output (self, other ,"DIA_Dusty_ABOUT_BONIE_03_05"); //To morderca jeszcze gorszy ni¿ Herek. Torturowa³ swoje ofiary przed œmierci¹!
    AI_Output (self, other ,"DIA_Dusty_ABOUT_BONIE_03_06"); //To barbarzyñca! Do tego ma chody u Stra¿ników. Szakal jest ponoæ jego kumplem.
    AI_Output (self, other ,"DIA_Dusty_ABOUT_BONIE_03_07"); //Nie przepuœci ciê dalej, jeœli nie zap³acisz mu dwudziestu bry³ek rudy.
    AI_Output (self, other ,"DIA_Dusty_ABOUT_BONIE_03_08"); //Nawet nie próbuj z nim walczyæ. Ma op³acon¹ ochronê!
    AI_Output (other, self ,"DIA_Dusty_ABOUT_BONIE_15_09"); //Dziêki.
    AI_StopProcessInfos	(self);
};
...
INSTANCE DIA_Dusty_RUNY_INFO_2 (C_INFO)
{
   ...
   permanent	= FALSE;
   description	= "Hej, Dusty. Jak sobie radzisz jako uczeñ Tondrala?";
};
...
{
    AI_Output (other, self ,"DIA_Dusty_RUNY_INFO_2_15_01"); //Hej, Dusty. Jak sobie radzisz jako uczeñ Tondrala?
    AI_Output (self, other ,"DIA_Dusty_RUNY_INFO_2_03_02"); //¯yje mi siê tu sto razy lepiej ni¿ w Starym Obozie. Przynajmniej nie jestem wyzyskiwany przez tych dupków z Gomezem na czele.
    AI_Output (self, other ,"DIA_Dusty_RUNY_INFO_2_03_03"); //Baal Tondral to wymagaj¹cy nauczyciel i potrafi daæ w koœæ, jednak lepsze to ni¿ u¿eranie siê ze Stra¿nikami.
    AI_Output (other, self ,"DIA_Dusty_RUNY_INFO_2_15_04"); //Skoro rozmawiamy o nauce, czy Baal Tondral uczy³ ciê ju¿, jak korzystaæ z magicznych run?
    AI_Output (self, other ,"DIA_Dusty_RUNY_INFO_2_03_05"); //Taa... Pewnego dnia przyniós³ z chaty runê Uderzenia Wiatru. Æwiczyliœmy ca³ymi godzinami.
