...
func void Info_TPL_1442_FirstWarn_Info()
{
	...
	AI_Output		(self, hero,"Info_TPL_1442_FirstWarn_13_01"); //STÓJ! Na œwi¹tynne wzgórze mo¿na wejœæ tylko za pozwoleniem któregoœ z Guru!
...
func void Info_TPL_1442_FirstWarn_Condition_YBERION ()
{
	...
	AI_Output (self, hero,"Info_TPL_1442_FirstWarn_Condition_YBERION_13_02"); //K³amcy ³atwo mog¹ straciæ jêzyk, wiêc uwa¿aj co mówisz.
};

func void Info_TPL_1442_FirstWarn_Condition_LESTER ()
{
	AI_Output (hero, self,"Info_TPL_1442_FirstWarn_Condition_LESTER_15_01"); //Przysy³a mnie Nowicjusz Lester. Chcia³bym ofiarowaæ moje us³ugi Y'Berionowi.
	AI_Output (self, hero,"Info_TPL_1442_FirstWarn_Condition_LESTER_13_02"); //Znam Lestera. Mo¿na mu zaufaæ. Mo¿esz przejœæ.
	Info_Clearchoices 	(Info_TPL_1442_FirstWarn);
...
{
	AI_Output 		(self, hero,"Info_TPL_1442_LastWarn_13_01"); 		//Jeszcze jeden krok, a bêdzie po tobie.
