...
instance Info_FreemineOrc_FIREWARAN2 (C_INFO)
{
	...
	important	= 0;	
	permanent	= 0;
	description = "Gdzie mogê znaleŸæ takiego smoka?";
};                       
...
{
	AI_Output			(hero, self,"Info_FreemineOrc_TROLL2_15_01"); //Gdzie mogê znaleŸæ yrolle?
...
instance Info_FreemineOrc_EVERYULUMULU (C_INFO)
{
	...
	important	= 0;	
	permanent	= 0;
	description = "Mam ju¿ wszystkie przedmioty potrzebne do sporz¹dzenia Ulu-Mulu!";
};                       
