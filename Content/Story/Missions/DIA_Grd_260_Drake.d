...
if (!Npc_KnowsInfo   (hero,DIA_Torrez_Gomez_success))
{
	...
	{
	AI_Output (self, other,"Grd_260_Drake_GARDEAUFNAHME_Info_11_03"); //Hej, nieŸle sobie poradzi³eœ z tymi pe³zaczami! 
	AI_Output (self, other,"Grd_260_Drake_GARDEAUFNAHME_Info_11_04"); //Szkoda tylko, ¿e wolisz zadawaæ siê z Magami.
	};
};
...
{
    AI_Output (self, other ,"DIA_Drake_DOK_03_01"); //Dopiero co tu przylaz³eœ, a ju¿ chcesz wychodziæ? Nie tak prêdko...
	AI_Output (other, self ,"DIA_Drake_DOK_15_02"); //S³uchaj, mam tu bardzo wa¿n¹ listê od Iana. Ta lista musi SZYBKO trafiæ do Starego Obozu, wiêc lepiej mnie nie zatrzymuj, bo inaczej bêdziemy mieæ obaj przechlapane.
    AI_Output (self, other ,"DIA_Drake_DOK_03_03"); //O cholerka. Czyli wkrótce nowa dostawa? W takim razie przechodŸ.
    AI_StopProcessInfos	(self);
};