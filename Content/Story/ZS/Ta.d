...
func void TA_UseHorn		(var int start_h, var int start_m, var int stop_h, var int stop_m, VAR string waypoint)	{TA_Min		(self,	start_h,start_m, stop_h, stop_m,ZS_UseHorn ,		waypoint);};
func void TA_Opetany		(var int start_h, var int start_m, var int stop_h, var int stop_m, VAR string waypoint)	{TA_Min		(self,	start_h,start_m, stop_h, stop_m,ZS_Opetany ,		waypoint);};
func void TA_Def		(var int start_h, var int start_m, var int stop_h, var int stop_m, VAR string waypoint)	{TA_Min		(self,	start_h,start_m, stop_h, stop_m,ZS_Def ,		waypoint);};
func void TA_WoodWork		(var int start_h, var int start_m, var int stop_h, var int stop_m, VAR string waypoint)	{TA_Min		(self,	start_h,start_m, stop_h, stop_m,ZS_WoodWork ,		waypoint);};
func void TA_StandDrunk		(var int start_h, var int start_m, var int stop_h, var int stop_m, VAR string waypoint)	{TA_Min		(self,	start_h,start_m, stop_h, stop_m,ZS_StandDrunk ,		waypoint);};
func void TA_Die		(var int start_h, var int start_m, var int stop_h, var int stop_m, VAR string waypoint)	{TA_Min		(self,	start_h,start_m, stop_h, stop_m,ZS_Die ,		waypoint);};
func void TA_StayIgnoring	(var int start_h, var int start_m, var int stop_h, var int stop_m, VAR string waypoint)	{TA_Min		(self,	start_h,start_m, stop_h, stop_m,ZS_NoFight ,	waypoint);};
//func void TA_Teaching_Tyon			(var int start_h, var int start_m, var int stop_h, var int stop_m, VAR string waypoint)	{TA_Min		(self,	start_h,start_m, stop_h, stop_m,ZS_Teaching_Tyon ,			waypoint);};
//func void TA_Teaching_Cadar			(var int start_h, var int start_m, var int stop_h, var int stop_m, VAR string waypoint)	{TA_Min		(self,	start_h,start_m, stop_h, stop_m,ZS_Teaching_Cadar ,			waypoint);};
//func void TA_Teaching_Tondral			(var int start_h, var int start_m, var int stop_h, var int stop_m, VAR string waypoint)	{TA_Min		(self,	start_h,start_m, stop_h, stop_m,ZS_Teaching_Tondral ,			waypoint);};
...
// Budzis Skrypt Mod
func void TA_skrzynka		(var int start_h, var int start_m, var int stop_h, var int stop_m, VAR string waypoint)	{TA_Min		(self,  start_h,start_m, stop_h, stop_m, ZS_OpenBox ,waypoint);};
//grzebanie w skrzyniach przez NPC
// *********************************************
