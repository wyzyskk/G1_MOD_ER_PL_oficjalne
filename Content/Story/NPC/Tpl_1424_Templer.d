...
FUNC VOID Rtn_start_1424 () //Tempelplatz links - See 1
{
	TA_Guard		(06,00,07,00,"PSI_PATH_TEMPLE_3");
	TA_Smalltalk	(07,00,08,00,"PSI_SWAMP_1");
	TA_Guard		(08,00,09,00,"PSI_PATH_TEMPLE_3");
	TA_Smalltalk	(09,00,10,00,"PSI_SWAMP_1");
	
	TA_Guard		(10,00,11,00,"PSI_PATH_TEMPLE_3");
	TA_Smalltalk	(11,00,12,00,"PSI_SWAMP_1");
	TA_Guard		(12,00,13,00,"PSI_PATH_TEMPLE_3");
	TA_Smalltalk	(13,00,14,00,"PSI_SWAMP_1");
	
	TA_Guard		(14,00,15,00,"PSI_PATH_TEMPLE_3");
	TA_Smalltalk	(15,00,16,00,"PSI_SWAMP_1");
	TA_Guard		(16,00,17,00,"PSI_PATH_TEMPLE_3");
	TA_Smalltalk	(17,00,18,00,"PSI_SWAMP_1");
	
	TA_Guard		(18,00,19,00,"PSI_PATH_TEMPLE_3");
	TA_Smalltalk	(19,00,20,00,"PSI_SWAMP_1");
	TA_Guard		(20,00,21,00,"PSI_PATH_TEMPLE_3");
	TA_Smalltalk	(21,00,22,00,"PSI_SWAMP_1");
	
	TA_Guard		(22,00,23,00,"PSI_PATH_TEMPLE_3");
	TA_Smalltalk	(23,00,00,00,"PSI_SWAMP_1");
	TA_Guard		(00,00,01,00,"PSI_PATH_TEMPLE_3");
	TA_Smalltalk	(01,00,02,00,"PSI_SWAMP_1");
	
	TA_Guard		(02,00,03,00,"PSI_PATH_TEMPLE_3");
	TA_Smalltalk	(03,00,04,00,"PSI_SWAMP_1");
	TA_Guard		(04,00,05,00,"PSI_PATH_TEMPLE_3");
