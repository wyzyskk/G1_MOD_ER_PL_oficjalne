...
FUNC VOID Rtn_wait_castle_4 ()
{	
	TA_Stand 		(00,00,	23,00,"PATH_TO_PLATEAU04_BRIDGE3");    
	TA_Stand		(23,00,	24,00,"PATH_TO_PLATEAU04_BRIDGE3");  
};	
FUNC VOID Rtn_help_castle_4 ()
{	
	TA_FollowPC 		(00,00,	23,00,"PATH_TO_PLATEAU04_BRIDGE3");    
	TA_FollowPC			(23,00,	24,00,"PATH_TO_PLATEAU04_BRIDGE3");  
};	
FUNC VOID Rtn_help_castle2_4 ()
{	
	TA_Def 			(00,00,	23,00,"BM_LESTER");    
	TA_Def			(23,00,	24,00,"BM_LESTER");  
};

FUNC VOID Rtn_spotkanie_4 ()
{	
	TA_Smoke 			(00,00,	23,00,"OW_PATH_093");    
	TA_Smoke			(23,00,	24,00,"OW_PATH_093");  
};
