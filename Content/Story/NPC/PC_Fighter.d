...
FUNC VOID Rtn_spotkanie_3 () 
{	
	TA_SItCAMPFIRE		(08,00,01,00,"SPT_GORN");    
	TA_SItCAMPFIRE		(01,00,08,00,"SPT_GORN");
};
//##################################################################
//	Kapitel 3
//##################################################################
...
{	
	TA_Stand			(00,00,	23,00,"NC_PATH52");    
	TA_Stand			(23,00,	24,00,"NC_PATH52");     
};	

// Gorn wartet vor der Klosterruine auf den Spieler
FUNC VOID Rtn_RuinWait_3 ()
{	
	TA_Stand			(00,00,	23,00,"OW_PATH_ABYSS_4");    
	TA_Stand			(23,00,	24,00,"OW_PATH_ABYSS_4");     
};	
...
{	
	TA_FollowPC_Gorn		(00,00,	23,00,"OW_PATH_176");    
	TA_FollowPC_Gorn		(23,00,	24,00,"OW_PATH_176");     
};	

// Gorn wartet im Innenhof der Klostermauern
FUNC VOID Rtn_RuinStay_3 ()
{	
	TA_Stand			(00,00,	23,00,"OW_PATH_176");    
	TA_Stand			(23,00,	24,00,"OW_PATH_176");     
};	
...
{	
	TA_Stand		(00,00,	23,00,"NC_KDW_CAVE_CENTER");    
	TA_Stand		(23,00,	24,00,"NC_KDW_CAVE_CENTER");     
};	

// Gorn bewacht den Weg zwischen Neuem Lager und Freier Mine
FUNC VOID Rtn_GuardNC_3 ()
{	
	TA_Stand		(00,00,	23,00,"OW_PATH_075_GUARD4");    
	TA_Stand		(23,00,	24,00,"OW_PATH_075_GUARD4");     
};	

// Gorn folgt dem Spieler zur Freien Mine bis zum Eingang des Lagers
FUNC VOID Rtn_FollowToFMC_3 ()
{	
	TA_FollowPC_Gorn	(00,00,	23,00,"FMC_ENTRANCE");    
	TA_FollowPC_Gorn	(23,00,	24,00,"FMC_ENTRANCE");     
};	

// Gorn wartet am Eingang des FreeMineCamps bis der Spieler unten am Mineneingang ist
FUNC VOID Rtn_WaitFMC_3 ()
{	
	TA_Stand		(00,00,	23,00,"FMC_ENTRANCE");    
	TA_Stand		(23,00,	24,00,"FMC_ENTRANCE");     
};	

// Gorn bewacht den Eingang zur Freien Mine während der Spieler das Tor öffnet
FUNC VOID Rtn_WaitFM_3 ()
{	
	TA_Stand		(00,00,	23,00,"FMC_FM_ENTRANCE");    
	TA_Stand		(23,00,	24,00,"FMC_FM_ENTRANCE");     
};	
...
{	
	TA_FollowPC_Gorn	(00,00,	23,00,"FM_02");    
	TA_FollowPC_Gorn	(23,00,	24,00,"FM_02");     
};	

// Der Spieler hat Gorn zurückgelassen und zieht auf eigene Faust los.
FUNC VOID Rtn_Wait_5 ()
{	
	TA_Stand	(00,00,	23,00,"FM_02");    
	TA_Stand	(23,00,	24,00,"FM_02");     
};	
