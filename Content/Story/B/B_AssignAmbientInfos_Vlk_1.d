...
INSTANCE Info_Vlk_1_GiveOre(C_INFO) // E7 xD
{
	nr			= 5;
...
{
	AI_Output(other,self,"Info_Vlk_1_GiveOre_15_00"); //P³aæ za ochronê!
	AI_Output(self,other,"Info_Vlk_1_GiveOre_01_01"); //Dobra ju¿ dobra. Zap³acê.
