...
INSTANCE Info_Vlk_4_GiveOre(C_INFO) // E7 xD
{
	nr			= 5;
	condition	= Info_Vlk_4_GiveOre_Condition;
	information	= Info_Vlk_4_GiveOre_Info;
	permanent	= 1;
	description = "P³aæ za ochrone!";
};                       

FUNC INT Info_Vlk_4_Giveore_Condition()
{
if (hero.guild == GIL_GRD)
&& (dzien_vlk4 != wld_getday())
{
	return 1;
};
};

FUNC VOID Info_Vlk_4_GiveOre_Info()
{
	AI_Output(other,self,"Info_Vlk_4_GiveOre_15_00"); //P³aæ za ochronê!
	AI_Output(self,other,"Info_Vlk_4_GiveOre_01_01"); //Spokojnie. WeŸ tê rudê.
...
FUNC VOID B_AssignAmbientInfos_Vlk_4(var c_NPC slf)
{
	...
	Info_Vlk_4_GiveOre.npc				= Hlp_GetInstanceID(slf);
};
