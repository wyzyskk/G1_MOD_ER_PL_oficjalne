...
// SC Dialog
	...
	var string KazanieCadar1;	
	var string KazanieCadar2;	
	var string KazanieCadar3;	
	var string KazanieCadar4;	
	var string KazanieCadar5;	
	var string KazanieCadar6;	
	var string KazanieCadar7;	
	var string KazanieCadar8;
	var string KazanieCadar9;		
};
...
instance SVM_2 (C_SVM)				// Misstrauisch
{
	...
	KazanieCadar1					=	"ZS_Meditate_KazanieReloadCadar1";//Wiele lat Œni¹cy powo³a³ Y'Beriona i uczyni³ go swym prorokiem, a ci co za nim pod¹¿yli stali siê ludem wybranym.
	KazanieCadar2					=	"ZS_Meditate_KazanieReloadCadar2";//W chwili, w której po raz pierwszy wst¹pili na œcie¿kê zbawienia, powsta³ równie¿ Pierwszy Kr¹g. 
	KazanieCadar3					=	"ZS_Meditate_KazanieReloadCadar3";//Magia runiczna staje siê zrozumia³a dla ka¿dego, kto pod¹¿a œladem Œni¹cego.
	KazanieCadar4					=	"ZS_Meditate_KazanieReloadCadar4";//Œni¹cy obdarzy³ swój lud magi¹ na znak przymierza zawartego miêdzy nim i Y'Berionem. 
	KazanieCadar5					=	"ZS_Meditate_KazanieReloadCadar5";//A lud wybrany oddawszy siê Œni¹cemu, otrzyma³ od niego moc w³adania magi¹.
	KazanieCadar6					=	"ZS_Meditate_KazanieReloadCadar6";//Powierzy³ przeto Œni¹cy swemu ludowi w³adzê nad snem i umys³em, wyzwalaj¹c je z spod wp³ywu fa³szywej wiary.
	KazanieCadar7					=	"ZS_Meditate_KazanieReloadCadar7";//A ci co pod¹¿yli œcie¿k¹ Œni¹cego, posiedli w³adzê nad myœl¹, tak ¿e ich myœl by³a zdolna poruszyæ ziemiê i kamieñ, wiatr i burzê, a nawet zmieniæ ludzki umys³.
	KazanieCadar8					=	"ZS_Meditate_KazanieReloadCadar8";//Uczyni³ nas tedy wolnymi wpierw w umys³ach naszych, po wtóre wolnymi tu - na tych uœwiêconych jego kultem ziemiach. 
	KazanieCadar9					=	"ZS_Meditate_KazanieReloadCadar9";//Od niego i przez dan¹ nam od niego magiê przyjdzie te¿ wyzwolenie spod jarzma magicznej bariery.
...
instance SVM_6 (C_SVM)				//Raufbold	(Will saufen und raufen	(Matrose) Alkoholiker. Grölt viel)
{
	...
	YouWannaFoolMe				=	"SVM_6_YouWannaFoolMe"				;//JCo jest? Myœlisz, ¿e jestem taki g³upi?
...
instance SVM_9 (C_SVM)				// brummig		   gemütlicher Hüne, Besonnen, Brummiger Bär, Einfacher	Mensch
{
	...
	ThereHeIs					= 	"SVM_13_ThereHeIs"					;//Oœlep³eœ? Tutaj!//*** 9er war falsch betont!***
...
instance SVM_11	(C_SVM)				//Profi				Ruhig, abgezockt, Vernünftig aberknallhart
{
	...
	ThereHeIs					= 	"SVM_13_ThereHeIs"						;//Oœlep³eœ? Tutaj! //*** 11er war falsch betont!***
