...
PROTOTYPE Mst_Default_UndeadOrcWarrior (C_Npc)			
{
	...
	level							=	Level_UndeadOrcWarrior;//25;
//----------------------------------------------------------	
...
func void Set_UndeadOrcMessenger_Visuals()
{
	Mdl_SetVisual			(self,	"Orc.mds");
	//								Body-Mesh		Body-Tex	Skin-Color	Head-MMS	Head-Tex	Teeth-Tex	ARMOR
	Mdl_SetVisualBody		(self,	"UOW_Body",		1,	DEFAULT,	"",			DEFAULT,  	DEFAULT,	-1);
};
/*************************************************************************
**	Orc Warrior Undead    												**
*************************************************************************/
...
INSTANCE OrcMessengerRecalled (Mst_Default_UndeadOrcWarrior)
{
	name										=	"Orkowy Pos³aniec z Zaœwiatów";
	level											=	40;
...
//----------------------------------------------------------	
	...
	Set_UndeadOrcMessenger_Visuals();
	EquipItem 				(self, ItMw2hOrcMace01);
};