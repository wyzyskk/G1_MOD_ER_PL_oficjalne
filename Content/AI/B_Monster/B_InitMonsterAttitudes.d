...
func void B_InitMonsterAttitudes ()
{
	...
	B_SetGuildAttitude	(GIL_MINECRAWLER,	ATT_NEUTRAL,	GIL_TROLL			);
	...
	B_SetGuildAttitude	(GIL_MINECRAWLER,	ATT_NEUTRAL,	GIL_DEMON			); // er 1.4 opuszczona kopalnia
	...
	B_SetGuildAttitude	(GIL_MINECRAWLER,	ATT_NEUTRAL,	GIL_UNDEADORC		); // er 1.4.7 œwi¹tynia œni¹cego
	B_SetGuildAttitude	(GIL_MINECRAWLER,	ATT_NEUTRAL,	GIL_SKELETON		); // er 1.4 opuszczona kopalnia
	...
	B_SetGuildAttitude	(GIL_DEMON,			ATT_NEUTRAL,	GIL_MINECRAWLER		); // er 1.4 opuszczona kopalnia
	...
	B_SetGuildAttitude	(GIL_UNDEADORC,		ATT_NEUTRAL,	GIL_MINECRAWLER		); // er 1.4.7 œwi¹tynia œni¹cego
	...
	B_SetGuildAttitude	(GIL_UNDEADORC,		ATT_NEUTRAL,	GIL_ORCSCOUT		);
	B_SetGuildAttitude	(GIL_UNDEADORC,		ATT_NEUTRAL,	GIL_ORCWARRIOR		);
	B_SetGuildAttitude	(GIL_UNDEADORC,		ATT_NEUTRAL,	GIL_ORCSHAMAN		);
	//-------- ORCDOG --------
	...
	B_SetGuildAttitude	(GIL_SKELETON,		ATT_NEUTRAL,	GIL_MINECRAWLER		); //fix 1.4 OPUSZCZONA KOPALNIA!! 
	...
	//er path budzis 
		B_SetGuildAttitude      (GIL_GRD                ,       ATT_HOSTILE,    GIL_ORCWARRIOR          );
		B_SetGuildAttitude      (GIL_STT                ,       ATT_HOSTILE,    GIL_ORCWARRIOR          );
		B_SetGuildAttitude      (GIL_TPL                ,       ATT_HOSTILE,    GIL_ORCWARRIOR          );
		B_SetGuildAttitude      (GIL_BAU                ,       ATT_HOSTILE,    GIL_ORCWARRIOR          );
		B_SetGuildAttitude      (GIL_VLK                ,       ATT_HOSTILE,    GIL_ORCWARRIOR          );
		
		B_SetGuildAttitude      (GIL_GRD                ,       ATT_HOSTILE,    GIL_ORCSCOUT            );
		B_SetGuildAttitude      (GIL_STT                ,       ATT_HOSTILE,    GIL_ORCSCOUT            );
		B_SetGuildAttitude      (GIL_TPL                ,       ATT_HOSTILE,    GIL_ORCSCOUT            );
        B_SetGuildAttitude      (GIL_BAU                ,       ATT_HOSTILE,    GIL_ORCSCOUT            );
        B_SetGuildAttitude      (GIL_VLK                ,       ATT_HOSTILE,    GIL_ORCSCOUT            );
		
        B_SetGuildAttitude      (GIL_GRD                ,       ATT_HOSTILE,    GIL_ORCSHAMAN           );
        B_SetGuildAttitude      (GIL_STT                ,       ATT_HOSTILE,    GIL_ORCSHAMAN           );
        B_SetGuildAttitude      (GIL_TPL                ,       ATT_HOSTILE,    GIL_ORCSHAMAN           );
        B_SetGuildAttitude      (GIL_BAU                ,       ATT_HOSTILE,    GIL_ORCSHAMAN           );
        B_SetGuildAttitude      (GIL_VLK                ,       ATT_HOSTILE,    GIL_ORCSHAMAN           );
		/*
        B_SetGuildAttitude      (GIL_ORCWARRIOR,                ATT_HOSTILE,    GIL_SEPERATOR_HUM       );
        B_SetGuildAttitude      (GIL_ORCSCOUT,          ATT_HOSTILE,    GIL_SEPERATOR_HUM       );
        B_SetGuildAttitude      (GIL_ORCSHAMAN,         ATT_HOSTILE,    GIL_SEPERATOR_HUM       );
